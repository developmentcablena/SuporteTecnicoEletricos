...
Public Sub ConectarBD()
    ...
    strBD = "PROVIDER=SQLOLEDB;SERVER=192.168.0.249\SQLExpress;DATABASE=HelpDesk;UID=cablena_user;PWD=C@bl3na;"
    'strBD = "PROVIDER=SQLOLEDB;SERVER=TELSIS001;DATABASE=HelpDesk;UID=helpdesk;PWD=H3lpD3sk;"
    'Conexão com a Elétricos
    'strBD = "PROVIDER=SQLOLEDB;SERVER=196.200.80.10;DATABASE=HelpDesk;UID=cablena_user;PWD=C@bl3na;"
